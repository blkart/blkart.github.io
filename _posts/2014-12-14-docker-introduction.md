...
![选区_002.png](https://github.com/blkart/blkart.github.io/blob/master/img/blog_img/%E9%80%89%E5%8C%BA_002.png)

#### 每一个虚拟机不仅仅包含应用程序（这也许只是MB级）和必要的二进制文件和库，而是整个操作系统（这可能是GB级的）

### Docker

![选区_003.png](https://github.com/blkart/blkart.github.io/blob/master/img/blog_img/%E9%80%89%E5%8C%BA_003.png)
